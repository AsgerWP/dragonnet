...
def _generate_data(n=1000, n_covariates=10, average_treatment_effect=3):
    ...
    outcomes = _get_outcomes(covariates, average_treatment_effect, treatments) + np.random.normal(0, 1, n)
...
def _get_outcomes(covariates, theta, average_treatment_effect):
    return (
